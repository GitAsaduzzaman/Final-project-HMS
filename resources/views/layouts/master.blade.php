		...
		<div class="header">
			<div class="header-left">
				<a href="{{ route('home') }}" class="logo" style="text-decoration: none;"> 
					<img src="{{ URL::to('assets/img/product/product-01.jpg') }}" width="50" height="70" alt="logo"> 
					<span class="logoclass">HOTEL</span> 
				</a>
				<a href="{{ route('home') }}" class="logo logo-small"> <img src="{{ URL::to('assets/img/profile/me.jpeg') }}" alt="Logo" width="30" height="30"> </a>
			</div>
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img class="rounded-circle" src="{{ URL::to('assets/img/profiles/avatar-01.jpg') }}" width="31" alt="Asaduzzaman"></span> </a>
