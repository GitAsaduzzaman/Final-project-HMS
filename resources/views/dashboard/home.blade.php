...
autoplay="true" autoplay-delay="3000" autoplay-disable-on-interaction="false">
  <swiper-slide>
    <img src="{{ asset('assets/images/rooms/2.png') }}" alt="Room Image 2">
  </swiper-slide>
  <swiper-slide>
    <img src="{{ asset('assets/images/rooms/3.png') }}" alt="Room Image 3">
  </swiper-slide>
  <swiper-slide>
    <img src="{{ asset('assets/images/rooms/4.png') }}" alt="Room Image 4">
  </swiper-slide>
  <swiper-slide>
    <img src="{{ asset('assets/images/rooms/5.png') }}" alt="Room Image 5">
  </swiper-slide>
</swiper-container>
